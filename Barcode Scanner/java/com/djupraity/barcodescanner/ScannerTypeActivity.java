...
public class ScannerTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiButton.setOnClickListener(v -> {
            Intent intent = new Intent(ScannerTypeActivity.this, WiFiScanActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            startActivity(new Intent(ScannerTypeActivity.this, WiFiHelpActivity.class));
            return true;
        } else if (id == R.id.menu_set_ip) {
            showIpInputDialog();
            return true;
        }else if (id == R.id.menu_pp) {
            startActivity(new Intent(ScannerTypeActivity.this, PrivacyPolicy.class));
            return true;
    ...
    private void showIpInputDialog() {
        ...
        builder.setPositiveButton("Save", (dialog, which) -> {
            ...
            if (isValidIp(ip)) {
                ...
                editor.apply();
                Toast.makeText(ScannerTypeActivity.this, "IP saved: " + ip, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(ScannerTypeActivity.this, "Invalid IP address", Toast.LENGTH_SHORT).show();
            }
        });
